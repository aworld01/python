...
rbt1 = Radiobutton(root, text="Male", value="male", variable=gender, command=change).grid(row=0, column=0, padx=(120, 0), pady=20)
rbt2 = Radiobutton(root, text="Female", value="female", variable=gender, command=change).grid(row=0, column=1)
